  ...
  return (
    <>
      <section className={style.main__container_survey}>
        <h2>Предоставление услуг с использованием сайта в сети Интернет</h2>
        <Field name="first" component={ToggleSwitch} type="checkbox" />
        <OnChange
          name="first"
      ...
      <section className={style.main__container_survey}>
        ...
        <Field name="second" component={ToggleSwitch} type="checkbox" />
        <OnChange
          name="second"
          onChange={(value: string) => {
            dispatch({
      ...
      <section className={style.main__container_survey}>
        ...
        <Field name="third" component={ToggleSwitch} type="checkbox" />
        <OnChange
          name="third"
          onChange={(value: string) => {
            dispatch({
      ...
      <section className={style.main__container_survey}>
        ...
        <Field name="fourth" component={ToggleSwitch} type="checkbox" />
        <OnChange
          name="fourth"
          onChange={(value: string) => {
            dispatch({
      ...
      <section className={style.main__container_survey}>
        ...
        <Field name="fifth" component={ToggleSwitch} type="checkbox" />
        <OnChange
          name="fifth"
          onChange={(value: string) => {
            dispatch({
