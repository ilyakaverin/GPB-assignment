import { StoreInterface, NEW_LICENSE, FILL_STATE_INTERFACE } from "./interfaces"
...
interface ACTIONMAP {
  ...
  setInitStateFilling: () => StoreInterface
}
export const stateReducer = (store: StoreInterface, action: ACTIONTYPE) => {
  ...
  const actionMap: ACTIONMAP = {
    ...
    setInitStateFilling: () => {
        return {...store, state: {...store.state, fillState: {...store.state.fillState, currentLicense: 'initialized'}}}
    },
    currentLicense: () => ({
      ...store,
      currentLicense: {
    ...
    clearLicenseForm: () => {
      ...
      const copy: NEW_LICENSE = { ...store.currentLicense }
