import {
    StoreInterface,
    NEW_LICENSE,
    FILL_STATE_INTERFACE
} from "./interfaces";
import {
    License
} from "./models/licence";
export type ACTIONTYPE = {
    type: string;datakey:string;payload ? : any
};
interface ACTIONMAP {
    data: () => StoreInterface;
...
export const stateReducer = (store: StoreInterface, action: ACTIONTYPE) => {
    ...
    const actionMap: ACTIONMAP = {
        ...
        addLicense: () => {
            ...
            return {
                ...store,
                [datakey]: updatedStoreofLicenses
            };
        },
        clearLicenseForm: () => {
        ...
        checkFilling: () => {
            ...
            return {
                ...
                state: {
                    ...store.state,
                    fillState: {
                        ...store.state.fillState,
                        [datakey]: isAllFieldsFilled
                    },
                },
            };
        },
